...
import { VaultAbi } from "../../abi/syncSwap/VaultAbi.js";
import { PoolAbi } from "../../abi/syncSwap/PoolAbi.js";
import { RouterAbi } from "../../abi/syncSwap/RouterAbi.js";
import { factoryAbi } from "../../abi/syncSwap/PoolFactory.js";
...
async function main() {
    ...
    const connection = new Connection('ZK_SYNC', account.privateKey, 'DEFAULT')
    const ethConnection = new Connection('ETHEREUM', account.privateKey)
